...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{visualizations/geographic_inequity_analysis.png}
\caption{Geographic Inequity: 52\% of states provide low protection while only 19\% provide high protection.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.48\textwidth]{visualizations/legislative_momentum_analysis.png}
\caption{671 bills introduced in 2025 (record high) demonstrate urgent legislative momentum.}
\end{figure}
